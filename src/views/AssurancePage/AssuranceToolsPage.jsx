                ...
                <GridContainer justify="center">
                  <GridItem xs={12} sm={12} md={8}>
                    ...
                    <h5 className={classes.description}>
                      Bagian ini menjelaskan terkait IT Tools yang digunakan dalam proses assurance. Yuk pelajari kegunaan masing-masing toolsnya!
                    </h5>
                  </GridItem>
                </GridContainer>
                <div>
                  ...
                  <Navigator nextPage="/woc" prevPage="/assurance/wo" />
                </div>
              </div>
            </div>
          </div>
