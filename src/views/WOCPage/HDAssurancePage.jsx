...
class HDAssurancePage extends React.Component {
  render() {
              ...
              <div className={classes.section}>
                <GridContainer justify="center">
                  <GridItem xs={12} sm={12} md={8}>
                    <h2 className={classes.subtitle}>Helpdesk Assurance</h2>
...
export default withStyles(blogPageStyle)(HDAssurancePage);
